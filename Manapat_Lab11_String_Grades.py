# Categorization for Types of Lists in Grading: Grades and Passing Grades
List_of_Grades = [] 
Passed_Grades = []
...
for x in range(5):  
    ...
    if Student_Grade_List >= 40 or Student_Grade_List <= 100: 
...
print(f"Passing Percentage (%): {Percentage_Passing_Grades}%")
print(f"Passed Students: {Passed_Students}/5")
